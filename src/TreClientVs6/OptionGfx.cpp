...
void OptionGfx::Init(SDL_Rect* pRect, SDL_Surface*  pScreen, TTF_Font* pFontTxt, TTF_Font* pFontWinCtrl)
{
    ...
    m_pComboAlg_Pl_1->Init(&rctBt1, pScreen,  m_pFontText, MYIDCOMBOALG_PL1);
    ...
    m_pComboAlg_Pl_2->Init(&rctBt1, pScreen,  m_pFontText, MYIDCOMBOALG_PL2);
    ...
    m_pComboAlg_Pl_3->Init(&rctBt1, pScreen,  m_pFontText, MYIDCOMBOALG_PL3);
    ...
    m_pComboAlg_Pl_4->Init(&rctBt1, pScreen,  m_pFontText, MYIDCOMBOALG_PL4);
    ...
    m_pProgSpeedAni->Init(&rctBt1, pScreen, NULL,  m_pFontText, MYIDPROGBARSPEEDANI);
...
///m_pCheckShowAlgControl->SetState(cCheckBoxGfx::VISIBLE); 
    ...
    while (!m_bTerminated)
    {
        ...
        {
            m_pProgSpeedAni->Draw(pShadowSrf); 
        }
        ...
        if (m_bShowAlgControls)
        {
            ...
            GFX_UTIL::DrawString(pShadowSrf, strFrameAlg.c_str(), m_pComboAlg_Pl_1->m_rctButt.x , 
                m_pComboAlg_Pl_1->m_rctButt.y - 45, GFX_UTIL_COLOR::Orange    , m_pFontText);

            // alg player labels
            GFX_UTIL::DrawString(pShadowSrf, strPlayer1.c_str(), m_pComboAlg_Pl_1->m_rctButt.x , 
                        m_pComboAlg_Pl_1->m_rctButt.y - 20, GFX_UTIL_COLOR::Orange , m_pFontText);
            GFX_UTIL::DrawString(pShadowSrf, strPlayer2.c_str(), m_pComboAlg_Pl_2->m_rctButt.x , 
                        m_pComboAlg_Pl_2->m_rctButt.y - 20, GFX_UTIL_COLOR::Orange , m_pFontText);
            GFX_UTIL::DrawString(pShadowSrf, strPlayer3.c_str(), m_pComboAlg_Pl_3->m_rctButt.x , 
                        m_pComboAlg_Pl_3->m_rctButt.y - 20, GFX_UTIL_COLOR::Orange , m_pFontText);
            GFX_UTIL::DrawString(pShadowSrf, strPlayer4.c_str(), m_pComboAlg_Pl_4->m_rctButt.x , 
                        m_pComboAlg_Pl_4->m_rctButt.y - 20, GFX_UTIL_COLOR::Orange , m_pFontText);
